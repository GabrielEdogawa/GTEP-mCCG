Set
     ...
     cg(g) Candidate Generators /g7, g8, g9,g10/
     ...
     mapCG(cg,n) Generator-Bus Mapping / g7.n5, g8.n5,  g9.n11, g10.n11/
...
$ontext
     ...
     mapCSL(cl,n) Sending Bus Mapping /l32.n1, l33.n5, l34.n5, l35.n5,  l36.n6,  l37.n6, l38.n6,
                          l39.n9, l40.n9,  l41.n12, l42.n12, l43.n12,  l44.n15, l45.n25,  l46.n27/
     mapCRL(cl,n) Receiving Bus Mapping /l32.n2, l33.n6, l34.n7, l35.n7, l36.n8, l37.n10, l38.n28,
...
cleq1(cl, rowset)..              cfm(cl, rowset) =g= (sum(n$mapCSL(cl,n), thetam(n, rowset)) -
                                 sum(n$mapCRL(cl,n), thetam(n, rowset))) / CLDATA(cl, '1') - M * (1-z1m(cl, rowset));
cleq2(cl, rowset)..              cfm(cl, rowset) =l= (sum(n$mapCSL(cl,n), thetam(n, rowset)) -
                                 sum(n$mapCRL(cl,n), thetam(n, rowset))) / CLDATA(cl, '1') + M * (1-z1m(cl, rowset));
cllim1(cl, rowset)..             cfm(cl, rowset) =g= - CLDATA(cl, '4')  * z1m(cl, rowset);
cllim2(cl, rowset)..             cfm(cl, rowset) =l= CLDATA(cl, '4')  * z1m(cl, rowset);
...
cglim1(cg, rowset)..             cpm(cg, rowset) =l= CGDATA(cg, 'Pmax') * z2m(cg, rowset);
cglim2(cg, rowset)..             cpm(cg, rowset) =g= CGDATA(cg, 'Pmin') * z2m(cg, rowset);
...
Loop(itera,
         ...
         if(ord(itera) > 1,
                 ...
                 UB(itera) = min(UB(itera-1), subdual.l +
                 sum(cl, CLDATA(cl, '5') * decision_l(cl)) + sum(cg, CGDATA(cg, 'IC') * decision_g(cg)));

                 break$((abs(UB(itera)-LB(itera))/UB(itera)) <= epsilon);
*                 break$(UB(itera) = UB(itera - 1));
