...
Free Variable
         remasobj
         efm(el,s, t, itera)           Line flow in line l
         cf1m(cl1,s, t, itera)
         cf2m(cl2,s, t, itera)
         cf3m(cl3,s, t, itera)
         cf4m(cl4,s, t, itera)
         cf5m(cl5,s, t, itera)
         thetam(n,s, t, itera)    Bus angle of bus n;

Positive Variable
         rm(d,s, t, itera)     load violation values
         epm(eg,s, t, itera)     Generation of Generator g
         cp1m(cg1,s, t, itera)
         cp2m(cg2,s, t, itera)
         cp3m(cg3,s, t, itera)
         cp4m(cg4,s, t, itera)
...
Lower(rowset)..          eta =e= sum(s, prob(s) * (sum(t, sum(eg, epm(eg,s, t, rowset) * EGDATA(eg, 'OC'))
                                  + sum(cg1, cp1m(cg1,s, t, rowset) * CGDATA1(cg1, 'OC')) + sum(cg2, cp2m(cg2,s, t, rowset) * CGDATA2(cg2, 'OC'))
                                  + sum(cg3, cp3m(cg3,s, t, rowset) * CGDATA3(cg3, 'OC')) + sum(cg4, cp4m(cg4,s, t, rowset) * CGDATA4(cg4, 'OC')) + sum(cg5, cp5m(cg5,s, t, rowset) * CGDATA5(cg5, 'OC'))
                                  + sum(d, rm(d,s, t, rowset) * PC)) ));

loadbalance(n,s, t, rowset)..         sum(cg1$mapCG1(cg1,n), cp1m(cg1,s, t, rowset)) + sum(cg2$mapCG2(cg2,n), cp2m(cg2,s, t, rowset)) + sum(cg3$mapCG3(cg3,n), cp3m(cg3,s, t, rowset)) + sum(cg4$mapCG4(cg4,n), cp4m(cg4,s, t, rowset)) + sum(cg5$mapCG5(cg5,n), cp5m(cg5,s, t, rowset)) +
                            sum(eg$mapEG(eg,n), epm(eg,s, t, rowset)) -
                            sum(cl1$mapCSL1(cl1,n), cf1m(cl1,s, t, rowset)) + sum(cl1$mapCRL1(cl1,n), cf1m(cl1,s, t, rowset)) -
                            sum(cl2$mapCSL2(cl2,n), cf2m(cl2,s, t, rowset)) + sum(cl2$mapCRL2(cl2,n), cf2m(cl2,s, t, rowset)) -
                            sum(cl3$mapCSL3(cl3,n), cf3m(cl3,s, t, rowset)) + sum(cl3$mapCRL3(cl3,n), cf3m(cl3,s, t, rowset)) -
                            sum(cl4$mapCSL4(cl4,n), cf4m(cl4,s, t, rowset)) + sum(cl4$mapCRL4(cl4,n), cf4m(cl4,s, t, rowset)) -
                            sum(cl5$mapCSL5(cl5,n), cf5m(cl5,s, t, rowset)) + sum(cl5$mapCRL5(cl5,n), cf5m(cl5,s, t, rowset)) -
                            sum(el$mapESL(el,n), efm(el,s, t, rowset)) + sum(el$mapERL(el,n), efm(el,s, t, rowset)) + sum(d$mapD(d,n), rm(d,s, t, rowset))
                            =e= sum(d$mapD(d,n), DDATAp(d) * 1.2 * ord(t));

eleq1(el,s, t, rowset)..              efm(el,s, t, rowset) =g= (sum(n$mapESL(el,n), thetam(n,s, t, rowset)) -
                                    sum(n$mapERL(el,n), thetam(n,s, t, rowset))) / ELDATA(el, '1') - M * AELm(el, t, rowset);
eleq2(el,s, t, rowset)..              efm(el,s, t, rowset) =l= (sum(n$mapESL(el,n), thetam(n,s, t, rowset)) -
                                    sum(n$mapERL(el,n), thetam(n,s, t, rowset))) / ELDATA(el, '1') + M * AELm(el, t, rowset);
ellim1(el,s, t, rowset)..             efm(el,s, t, rowset) =g= - (1-AELm(el, t, rowset)) * ELDATA(el, '4');
ellim2(el,s, t, rowset)..             efm(el,s, t, rowset) =l= (1-AELm(el, t, rowset)) * ELDATA(el, '4');

cleq11(cl1,s, t, rowset)..             cf1m(cl1,s, t, rowset) =g= (sum(n$mapCSL1(cl1,n), thetam(n,s, t, rowset)) -
                                    sum(n$mapCRL1(cl1,n), thetam(n,s, t, rowset))) / CLDATA1(cl1, '1') - M * (1-exlm1(cl1,t, rowset));
cleq12(cl1,s, t, rowset)..             cf1m(cl1,s, t, rowset) =l= (sum(n$mapCSL1(cl1,n), thetam(n,s, t, rowset)) -
                                    sum(n$mapCRL1(cl1,n), thetam(n,s, t, rowset))) / CLDATA1(cl1, '1') + M * (1-exlm1(cl1,t, rowset));
cleq21(cl2,s, t, rowset)..             cf2m(cl2,s, t, rowset) =g= (sum(n$mapCSL2(cl2,n), thetam(n,s, t, rowset)) -
                                    sum(n$mapCRL2(cl2,n), thetam(n,s, t, rowset))) / CLDATA2(cl2, '1') - M * (1-exlm2(cl2,t, rowset));
cleq22(cl2,s, t, rowset)..             cf2m(cl2,s, t, rowset) =l= (sum(n$mapCSL2(cl2,n), thetam(n,s, t, rowset)) -
                                    sum(n$mapCRL2(cl2,n), thetam(n,s, t, rowset))) / CLDATA2(cl2, '1') + M * (1-exlm2(cl2,t, rowset));
cleq31(cl3,s, t, rowset)..             cf3m(cl3,s, t, rowset) =g= (sum(n$mapCSL3(cl3,n), thetam(n,s, t, rowset)) -
                                    sum(n$mapCRL3(cl3,n), thetam(n,s, t, rowset))) / CLDATA3(cl3, '1') - M * (1-exlm3(cl3,t, rowset));
cleq32(cl3,s, t, rowset)..             cf3m(cl3,s, t, rowset) =l= (sum(n$mapCSL3(cl3,n), thetam(n,s, t, rowset)) -
                                    sum(n$mapCRL3(cl3,n), thetam(n,s, t, rowset))) / CLDATA3(cl3, '1') + M * (1-exlm3(cl3,t, rowset));
cleq41(cl4,s, t, rowset)..             cf4m(cl4,s, t, rowset) =g= (sum(n$mapCSL4(cl4,n), thetam(n,s, t, rowset)) -
                                    sum(n$mapCRL4(cl4,n), thetam(n,s, t, rowset))) / CLDATA4(cl4, '1') - M * (1-exlm4(cl4,t, rowset));
cleq42(cl4,s, t, rowset)..             cf4m(cl4,s, t, rowset) =l= (sum(n$mapCSL4(cl4,n), thetam(n,s, t, rowset)) -
                                    sum(n$mapCRL4(cl4,n), thetam(n,s, t, rowset))) / CLDATA4(cl4, '1') + M * (1-exlm4(cl4,t, rowset));
cleq51(cl5,s, t, rowset)..             cf5m(cl5,s, t, rowset) =g= (sum(n$mapCSL5(cl5,n), thetam(n,s, t, rowset)) -
                                    sum(n$mapCRL5(cl5,n), thetam(n,s, t, rowset))) / CLDATA5(cl5, '1') - M * (1-exlm5(cl5,t, rowset));
cleq52(cl5,s, t, rowset)..             cf5m(cl5,s, t, rowset) =l= (sum(n$mapCSL5(cl5,n), thetam(n,s, t, rowset)) -
                                    sum(n$mapCRL5(cl5,n), thetam(n,s, t, rowset))) / CLDATA5(cl5, '1') + M * (1-exlm5(cl5,t, rowset));

cllim11(cl1,s, t, rowset)..             cf1m(cl1,s, t, rowset) =g= - CLDATA1(cl1, '4') * exlm1(cl1,t, rowset);
cllim12(cl1,s, t, rowset)..             cf1m(cl1,s, t, rowset) =l= CLDATA1(cl1, '4') * exlm1(cl1,t, rowset);

cllim21(cl2,s, t, rowset)..             cf2m(cl2,s, t, rowset) =g= - CLDATA2(cl2, '4') * exlm2(cl2,t, rowset);
cllim22(cl2,s, t, rowset)..             cf2m(cl2,s, t, rowset) =l= CLDATA2(cl2, '4') * exlm2(cl2,t, rowset);

cllim31(cl3,s, t, rowset)..             cf3m(cl3,s, t, rowset) =g= - CLDATA3(cl3, '4') * exlm3(cl3,t, rowset);
cllim32(cl3,s, t, rowset)..             cf3m(cl3,s, t, rowset) =l= CLDATA3(cl3, '4') * exlm3(cl3,t, rowset);

cllim41(cl4,s, t, rowset)..             cf4m(cl4,s, t, rowset) =g= - CLDATA4(cl4, '4') * exlm4(cl4,t, rowset);
cllim42(cl4,s, t, rowset)..             cf4m(cl4,s, t, rowset) =l= CLDATA4(cl4, '4') * exlm4(cl4,t, rowset);

cllim51(cl5,s, t, rowset)..             cf5m(cl5,s, t, rowset) =g= - CLDATA5(cl5, '4') * exlm5(cl5,t, rowset);
cllim52(cl5,s, t, rowset)..             cf5m(cl5,s, t, rowset) =l= CLDATA5(cl5, '4') * exlm5(cl5,t, rowset);

eglim1(eg,s, t, rowset)..             epm(eg,s, t, rowset) =l= (1-AEGm(eg, t, rowset)) * EGDATA(eg, 'Pmax');
eglim2(eg,s, t, rowset)..             epm(eg,s, t, rowset) =g= (1-AEGm(eg, t, rowset)) * EGDATA(eg, 'Pmin');

cglim11(cg1,s, t, rowset)..             cp1m(cg1,s, t, rowset) =l= CGDATA1(cg1, 'Pmax') * exgm1(cg1,t, rowset);
cglim12(cg1,s, t, rowset)..             cp1m(cg1,s, t, rowset) =g= CGDATA1(cg1, 'Pmin') * exgm1(cg1,t, rowset);

cglim21(cg2,s, t, rowset)..             cp2m(cg2,s, t, rowset) =l= CGDATA2(cg2, 'Pmax') * exgm2(cg2,t, rowset);
cglim22(cg2,s, t, rowset)..             cp2m(cg2,s, t, rowset) =g= CGDATA2(cg2, 'Pmin') * exgm2(cg2,t, rowset);

cglim31(cg3,s, t, rowset)..             cp3m(cg3,s, t, rowset) =l= CGDATA3(cg3, 'Pmax') * exgm3(cg3,t, rowset);
cglim32(cg3,s, t, rowset)..             cp3m(cg3,s, t, rowset) =g= CGDATA3(cg3, 'Pmin') * exgm3(cg3,t, rowset);

cglim41(cg4,s, t, rowset)..             cp4m(cg4,s, t, rowset) =l= CGDATA4(cg4, 'Pmax') * exgm4(cg4,t, rowset);
cglim42(cg4,s, t, rowset)..             cp4m(cg4,s, t, rowset) =g= CGDATA4(cg4, 'Pmin') * exgm4(cg4,t, rowset);

cglim51(cg5,s, t, rowset)..             cp5m(cg5,s, t, rowset) =l= CGDATA5(cg5, 'Pmax') * exgm5(cg5,t, rowset);
cglim52(cg5,s, t, rowset)..             cp5m(cg5,s, t, rowset) =g= CGDATA5(cg5, 'Pmin') * exgm5(cg5,t, rowset);

lslimm(n,s, t, rowset)..              sum(d$mapD(d,n), rm(d,s, t, rowset)) =l= sum(d$mapD(d,n), DDATAp(d) * ord(t) * 1.2);
